      ...
      <div className="flex-1">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold text-text-light mb-2">Particles Background</h1>
            <p className="text-text-light/70 mb-8">An interactive particle network background using HTML Canvas.</p>
            
            <div className="glass rounded-lg p-8 mb-8 h-80 relative overflow-hidden">
              <canvas 
                ref={canvasRef} 
            ...
            <div className="space-y-6">
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-glass-dark backdrop-blur-sm">
                        <th className="border border-glass-border px-4 py-2 text-left text-text-light">Parameter</th>
                        <th className="border border-glass-border px-4 py-2 text-left text-text-light">Description</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">particleCount</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Number of particles to generate (affects performance)</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">maxDistance</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Maximum distance for drawing lines between particles</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">particle.size</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Size range for particles</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">particle.speed</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Speed range for particles</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">particle.color</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Color generation for particles</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div>
                <h2 className="text-xl font-semibold text-text-light mb-4">Performance Considerations</h2>
                <div className="glass rounded-lg p-6 text-text-light/80">
                  <p className="mb-4">
