      ...
      <div className="flex-1">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold text-text-light mb-2">Fade In Animation</h1>
            <p className="text-text-light/70 mb-8">A smooth fade-in animation with staggered children.</p>
            ...
            <div className="glass rounded-lg p-4 md:p-8 mb-8 flex items-center justify-center">
              ...
              >
                <motion.p variants={item} className="text-2xl font-bold text-white">
                  <span className="text-text-light">Fade in text animation</span>
                </motion.p>
