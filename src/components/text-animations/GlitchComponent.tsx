      ...
      <div className="flex-1">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold text-text-light mb-2">Glitch Text Effect</h1>
            <p className="text-text-light/70 mb-8">A cyberpunk-inspired glitch text effect using CSS animations.</p>
            
            <div className="glass rounded-lg p-8 mb-8 flex items-center justify-center">
              <h1 className="glitch text-3xl text-text-light" data-text="Glitch Effect">
                Glitch Effect
              </h1>
            </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">text-shadow</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Change the colors of the glitch effect</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">animation-duration</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Adjust the speed of the glitch animation</td>
                      </tr>
                      <tr>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">left</td>
                        <td className="border border-glass-border px-4 py-2 text-text-light/80">Change the offset of the glitch layers</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
